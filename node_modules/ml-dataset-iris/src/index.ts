import cvSetsK5 from 'ml-dataset-iris/src/data/cvSetsK5.json';
import cvSetsK7 from 'ml-dataset-iris/src/data/cvSetsK7.json';
import raw from 'ml-dataset-iris/src/data/iris.json';
import getNumericalClasses from 'ml-dataset-iris/src/utilities/getNumericalClasses';
